...
st.set_page_config(
    page_title="PRIVATE STOCK ANALYZER PRO",
    page_icon="🚀",
    layout="wide",
...
# Password Protection - SIMPLIFIED VERSION
def check_auth():
    ...
    if not st.session_state.authenticated:
        ...
        <div style='text-align: center; padding: 4rem;'>
            ...
            <h2>PRIVATE STOCK ANALYZER PRO</h2>
            <p style='font-size: 1.2rem; color: #6b7280;'>Enter password to access advanced analysis</p>
        </div>
        """, unsafe_allow_html=True)
